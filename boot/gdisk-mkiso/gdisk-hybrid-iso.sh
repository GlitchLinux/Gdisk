...
#
#  Dependencies: git, xorriso, dosfstools, grub-pc-bin
#
...
# ====================================================================
#  Step 2: Locate GRUB boot images
# ====================================================================
...
# ====================================================================
#  Step 3: Prepare ISO staging directory
# ====================================================================
...
# ====================================================================
#  Step 4: Build BIOS El Torito boot image
# ====================================================================
# GRUB BIOS CD boot uses cdboot.img (2048-byte CD sector loader)
# concatenated with core.img to form the El Torito boot image.
...
# ====================================================================
#  Step 5: Build UEFI El Torito boot image (efi.img)
# ====================================================================
# Create a 4MB FAT12 image with dd + mkfs.vfat, loop-mount it,
# and copy BOOTX64.EFI into it. This becomes both the El Torito
# EFI boot catalog entry AND the GPT EFI System Partition for
# isohybrid USB boot.
...
# ====================================================================
#  Step 6: Build hybrid ISO with xorriso
# ====================================================================
# Uses the same xorriso flags that grub-mkrescue generates:
#   --grub2-mbr boot_hybrid.img  = proper MBR for BIOS USB boot
#   -efi-boot-part               = GPT EFI System Partition for UEFI USB
#   --efi-boot-image             = marks efi.img as the ESP content
# This produces an ISO that Rufus/PowerISO recognize as BIOS+UEFI.
